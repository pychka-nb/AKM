...
// number8.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cnumber8App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cnumber8App

Cnumber8App::Cnumber8App()
{
...
// Единственный объект Cnumber8App

Cnumber8App theApp;


// Инициализация Cnumber8App

BOOL Cnumber8App::InitInstance()
{
